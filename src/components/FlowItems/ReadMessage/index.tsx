    ...
    return (
      <div className={isBot ? styles.TextComponentBot : styles.TextComponent}>
        <Space direction="horizontal">
          {isBroadcast ? <NotificationOutlined style={{ color: '#1890ff' }} /> : <></>}
...
export const ImageDisplayComponent: FC<DisplayComponentProps> = (props) => {
  ...
  return componentData.url ? (
    <Space direction="horizontal">
      {isBroadcast ? <NotificationOutlined style={{ color: '#1890ff' }} /> : <></>}
      <Image className={styles.ImageComponent} key={componentKey} src={componentData.url} />
    </Space>
  ) : (
    <></>
  );
...
export const GenericTemplateDisplayComponent: FC<DisplayComponentProps> = (props) => {
  ...
  return componentData.elements?.length ? (
    <Space direction="horizontal">
      {isBroadcast ? <NotificationOutlined style={{ color: '#1890ff' }} /> : <></>}
            ...
            componentData.elements?.map((element, index) => {
              if (
                ...
                return (
                  ...
                  >
                    <p>
                      <b>{renderLabel(element.title, searchQuery)}</b>
                    </p>
